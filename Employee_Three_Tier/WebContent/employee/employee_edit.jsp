            ...
            <td height="530" align="center" valign="top"><table width="100%" border="0">
              <tbody>
							 ...
							 if(!ErrorFlag)
	                		    {
								 ...
								 try
								 {
									 ...
									 result= EmployeeBl.employee_update(employee);
                ...
                else
                {
              	...
              	try
              	{
              		employee = EmployeeBl.getEmployee(employeeId);
              		
              		if(employee!=null)
              		{
              			
              		  semployeeId=employee.getEmployeeId();
              		  semployeeName=employee.getEmployeeName();
              		  sbasicPay=""+employee.getBasicPay();
